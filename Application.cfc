...
component {
	...
	this.mappings[ "/testmodule" ]   = COLDBOX_APP_ROOT_PATH & 'modules/testmodule';
	this.mappings[ "/coldbox" ] = COLDBOX_APP_ROOT_PATH & "coldbox";

	this.datasource = "testdb";
	this.ormenabled = true;
	this.ormsettings = {
		cfclocation: 'testmodule/models',
		// cfclocation: [ 'models/orm', 'testmodule/models' ],
		// cfclocation: [ 'models/orm', 'models/otherorm' ],
	...
	public void function onApplicationEnd( struct appScope ){
		if( structKeyExists( appScope, 'cbBootstrap' ) ){
